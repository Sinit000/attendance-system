    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="card card-info">
                ...
                <div class="card-body">
                    <div class="rows">
                        <form id="frmSubmit" method="GET" class="form-inline" action=" {{ url('admin/report/system') }}" target="_blank">
                            @csrf
                        ...
                        <br>
                        <div class="col-sm-12">
                            <button class="btn btn-small btn-primary pull-right" id="btn_print" type="">Print</button>
                        </div>
                        <br>
                    </div>
                    <div class="row">
                        ...
                        <table class="table table-sm table-hover table-bordered" id="user-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $row->timetable_id }}</td>
                                    <td class="text-center">{{ $row->checkin_time }}</td>
                                    <!-- <td class="text-center">{{ $row->checkin_status }}</td> -->
                                    <td class="text-center">{{ $row->checkin_late }}</td>
                                    <td class="text-center">{{ $row->checkout_time }}</td>
                                    <!-- <td class="text-center">{{ $row->checkout_status }}</td> -->
                                    <td class="text-center">{{ $row->checkout_late }}</td>
