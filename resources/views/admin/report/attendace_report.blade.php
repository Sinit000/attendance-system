        ...
        <div class="section-body">
            <div class="card card-info">
                <div class="card-header">
                    <div class="ml-auto">
                        <a href="{{url('admin/reports')}}" class="btn btn-primary ">Back</a>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function getData(startDate, endDate) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ url('admin/report/attendances') }}" + '/' + startDate + '/' + endDate,
                dataType: 'json',
                beforeSend: function() {
        ...
        function getEmployeeData(statUserDate, endUserDate, userId) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ url('admin/report/attendance/employee') }}" + '/' + userId + '/' + statUserDate + '/' + endUserDate,
                dataType: 'json',
                beforeSend: function() {
                    console.log('before send'); // Before we send the request, remove the .hidden class from the spinner and default to inline-block.
