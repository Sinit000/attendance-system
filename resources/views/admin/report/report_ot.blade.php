    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="card card-info">
                ...
                <div class="card-body">
                    <div class="rows">
                        <form id="frmSubmit" method="GET" class="form-inline" action=" {{ url('admin/report/overtimes') }}" target="_blank">
                            @csrf
                        ...
                        <table class="table table-sm table-hover table-bordered" id="user-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $row->ot_rate }}</td>
                                    <td class="text-center">{{ $row->ot_hour }}</td>
                                    <td class="text-center">{{ $row->ot_method }}</td>
                                    <td class="text-center">{{ $row->total_ot }}</td>
                                    <td class="text-center">{{ $row->date }}</td>
                                    <td class="text-center">{{ $row->requested_by }}</td>
                                    <td class="text-center">{{ $row->pay_type }}</td>
